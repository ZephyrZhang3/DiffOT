...
class ResnetBlock(nn.Module):
    ...
    def __init__(
        self, dim, hidden_dim, padding_type, norm_layer, use_dropout, use_bias
    ):
        ...
        self.conv_block = self.build_conv_block(
            dim, hidden_dim, padding_type, norm_layer, use_dropout, use_bias
        )
    ...
    def build_conv_block(
        ...
        conv_block += [
            nn.Conv2d(dim, hidden_dim, kernel_size=3, padding=p, bias=use_bias),
        ...
        if padding_type == "reflect":
            ...
            raise NotImplementedError("padding [%s] is not implemented" % padding_type)
        conv_block += [
            nn.Conv2d(hidden_dim, dim, kernel_size=3, padding=p, bias=use_bias),
            norm_layer(dim),
        ]
